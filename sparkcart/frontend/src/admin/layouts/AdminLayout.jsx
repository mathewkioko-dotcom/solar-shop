...
import { AdminNotificationProvider } from '../components/AdminNotifications'
...
export default function AdminLayout() {
  ...
  return <AdminNotificationProvider><div className="admin-shell">
    ...
    <aside className={`admin-sidebar ${drawerOpen ? 'is-open' : ''}`} aria-label="Admin navigation">
      ...
      <div className="admin-sidebar__footer"><Link to="/">↗ View Store</Link><button type="button" onClick={logout}>↪ Sign Out</button></div>
    </aside>
